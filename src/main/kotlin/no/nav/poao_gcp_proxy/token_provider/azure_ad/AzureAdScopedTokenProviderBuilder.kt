package no.nav.poao_gcp_proxy.token_provider.azure_ad

import no.nav.poao_gcp_proxy.token_provider.CachedScopedTokenProvider
import no.nav.poao_gcp_proxy.token_provider.OAuth2ScopedTokenProvider
import no.nav.poao_gcp_proxy.token_provider.ScopedTokenProvider
import no.nav.poao_gcp_proxy.token_provider.azure_ad.AzureAdEnvironmentVariables.AZURE_APP_CLIENT_ID
import no.nav.poao_gcp_proxy.token_provider.azure_ad.AzureAdEnvironmentVariables.AZURE_APP_CLIENT_SECRET
import no.nav.poao_gcp_proxy.token_provider.azure_ad.AzureAdEnvironmentVariables.AZURE_OPENID_CONFIG_TOKEN_ENDPOINT
